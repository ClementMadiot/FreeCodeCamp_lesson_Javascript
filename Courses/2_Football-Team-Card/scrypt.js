...
// "Object.freeze(obj)" freeze this object and prevent any changes being made to it.
Object.freeze(myFavoriteFootballTeam);

const { sport, team, year, players } = myFavoriteFootballTeam;
const { coachName, matches } = myFavoriteFootballTeam.headCoach;
// console.log(coachName, matches )
...
playersDropdownList.addEventListener("change", (e) => {
  ...
  switch (e.target.value) {
    case "nickname":
      //I Call the setPlayerCards function with an argument of players.filter().Inside the filter method, I add a callback function with a parameter called player and implicitly return player.nickname is not null.
