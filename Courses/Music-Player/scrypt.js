...
const playlistSongDelete = document.querySelector(".playlist-song-delete");
...
const deleteSong = (id) => {
  ...
  // check if the delete song is currently play
...
// display background current song
...
// display first song title before to click on play
